...
$packageName = 'eveonline' # arbitrary name for the package, used in messages
$installerType = 'EXE' #only one of these two: exe or msi
$url = 'http://content.eveonline.com/473035/EVE_Online_Installer_473035.exe' # download url
