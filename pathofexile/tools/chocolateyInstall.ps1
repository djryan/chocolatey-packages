...
$packageName = 'pathofexile' # arbitrary name for the package, used in messages
$installerType = 'msi' #only one of these two: exe or msi
$url = 'http://webcdn.pathofexile.com/downloads/PathOfExileInstaller.msi' # download url
