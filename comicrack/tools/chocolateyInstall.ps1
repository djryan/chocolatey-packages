...
$packageName = 'comicrack' # arbitrary name for the package, used in messages
$installerType = 'EXE_OR_MSI' #only one of these two: exe or msi
$url = 'http://comicrack.cyolito.com/downloads/func-download/110/chk,ab592beb2bf864b2febba5d9484c08af/no_html,1/' # download url
